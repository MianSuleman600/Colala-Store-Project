// src/components/referrals/models/WithdrawalModal.jsx
...
const WithdrawalModal = ({ isOpen, onClose, onSuccess, onWithdraw, brandColor = '#EF4444' }) => {
      ...
      <div className="relative bg-white rounded-3xl shadow-xl w-full max-w-md p-6">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div className="flex items-center space-x-2">
            ...
            />
            <label htmlFor="save-details" className="text-gray-700">
          ...
          <button
            ...
            style={{ backgroundColor: brandColor, opacity: submitting ? 0.85 : 1 }}
            disabled={submitting}
          >
