...
const ManagePointsTab = ({ 
  ...
  const gradientEndColor = '#8B008B'; // Purple, as in your original design
  ...
  return (
    <div>
        ...
        <div className="flex justify-between items-center">
          <div className="flex flex-col">
            ...
            <span className="text-3xl font-bold" style={{ color: contrastTextColor }}>
              {loading && totalPointsBalance === 0 ? '...' : Number(totalPointsBalance || 0).toLocaleString()}
            </span>
          </div>
          <Button
      ...
      {loading && customerPoints.length === 0 && (
        <div className="mb-4 text-sm text-gray-500 text-center">Loading customer points...</div>
      )}
